...
export default function MovimientosView({
    ...
    // Función auxiliar para formatear la fecha con hora localmente
    ...
    // Funciones auxiliares para el diseño de las etiquetas (badges)
    ...
    return (
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden flex flex-col h-full">
            ...
            {/* 1. HEADER DE HERRAMIENTAS (Buscador y Filtro) */}
                            ...
                            <tr>
                                <td colSpan="6" className="px-6 py-16 text-center text-gray-500">
                                    <div className="flex flex-col items-center justify-center">
                                        ...
                                        <p className="text-sm mt-1">Ajusta los filtros o registra una entrada/salida de inventario.</p>
                                    </div>
                                </td>
                            </tr>
                        ) : (
